    ...
    currentBlob.expand().then(() => {
      ...
      anime({
        targets: [
          ...
          contentInner.querySelectorAll(".experience-title > h4"),
          contentInner.querySelectorAll(".experience-title > h5"),
          contentInner.querySelectorAll(".experience-details > ul > li"),
          contentInner.querySelectorAll(".experience-chip > h5"),
          DOM.ctrlBack,
        ],
        duration: 200,
